    ...
    <div className={className}>
      ...
      <div className={styles.mediaBody}>
        ...
        <div className={styles.socialShareContainer}>
          <div class="facebook-share-button" onClick={() => {fbShare(url)}}>
            <svg fill="#ffffff" viewBox="0 0 24 24" width="16px" height="16px">
              <path d="M17.525,9H14V7c0-1.032,0.084-1.682,1.563-1.682h1.868v-3.18C16.522,2.044,15.608,1.998,14.693,2 C11.98,2,10,3.657,10,6.699V9H7v4l3-0.001V22h4v-9.003l3.066-0.001L17.525,9z"/>
            </svg> 
            Chia sẻ
          </div>
          {/* <div class="zalo-share-button" data-href={url} data-customize={true} data-oaid="579745863508352884" data-layout="2" data-color="blue"   data-callback="onZaloShared">data-customize=</div> */}
          ...
          <div  onClick={() => {
                logSocialShare({
                  ...
                  content_type: "image",
                    ...
                    <a class="zalo-share-button" data-href={url} data-oaid="579745863508352884" data-layout="icon-text" data-customize="true">
